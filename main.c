...
int main(int argc, char** argv)
{
	...
	if ((result = gds_db_new(&gds_db, "PM01B.gds")) != SUCCESS) {
		printf("Error %d opening GDS file\n", result);
		return 0;
	}
	...
	/* collapse cell @cell and write to file and polygon vector */
	vec* pset = vec_new();
